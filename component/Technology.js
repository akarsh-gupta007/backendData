const get = (req,res)=>{
    res.send([
        {
            "id": 21,
            "title": "Netflix announces spatial audio support for all compatible devices - Notebookcheck.net ",
            "Image": "https://www.notebookcheck.net/fileadmin/Notebooks/News/_nc3/DSC9411.jpg",
            "category": "Technology",
            "description": "Netflix has announced that it has partnered with Sennheiser to bring spatial audio to its platform. However, this new feature does presume that the individual user has a device that can support it. Accordingly, it should kick in automatically on many Apple pr…"
          },
          {
            "id": 56,
            "title": "Nothing Phone (1): Want to check phone's camera ahead of launch? Here's your chance - DNA India",
            "Image": "https://images.indianexpress.com/2022/05/K1.jpg",
            "category": "mix",
            "description": "The ‘Nothing Phone (1)’ is geared up to arrive on July 12 with dual rear cameras, and the company has shared a bunch of raw, unfiltered camera samples to show what all they are capable of.As per GSM Arena, in addition to sharing the camera samples, Nothing has also revealed the Phone (1)’s camera specs. The primary camera uses a 50 megapixels Sony IMX766 1/1.56-inch sensor with an f/1.88 aperture, while the ultrawide unit has a field of view of 114 degrees."
          },
          {
            "id": 52,
